...
class ProcesarXmlF4Command extends ContainerAwareCommand{

    protected function configure (){
        $this -> setName('analisis:procesaXmlF4');
        $this -> setDescription('Procesa un documento XML Feed4');
          ...
          if($file->getFilename() == ".DS_Store")continue;
            if(preg_match("/F4$/", $file->getPath())){
                  ...
                  $xml = simplexml_load_file($file);
                          ...
                          #echo  $atributos['away_team_id'] . " -- " . $atributos['away_team_name'] . " -- " . $atributos['competition'] . "\n";
