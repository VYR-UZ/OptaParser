...
class ProcesarXmlF24Command extends ContainerAwareCommand{

    protected function configure (){
        $this -> setName('analisis:procesaXmlF24');
        $this -> setDescription('Procesa un documento XML Feed24');
    ...
    protected function execute(InputInterface $input, OutputInterface $output){
        ...
        foreach ($iterator as $file) {
          if($file->getFilename() == ".DS_Store")continue;
            if(preg_match("/F24$/", $file->getPath())){
